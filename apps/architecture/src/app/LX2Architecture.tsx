...
const modules: Record<string, Module> = {
  ...
  score_entry: {
    ...
    features: [
      ...
      '"Finish round" banner → /rounds/[id] (summary page) with "View summary →" CTA',
  ...
  results: {
    ...
    status: 'planned', surface: 'player',
    sub: 'Permanent shareable event results page (full leaderboard, NTP/LD)',
    desc: 'Final event results at a permanent URL. Shared via WhatsApp after the round. Never expires. Distinct from round_summary (which is per-player scorecard); results is the event-level leaderboard with NTP/LD winners, OG share card, and optional prize display. Only available after organiser finalises the event.',
    ...
    features: ['Final standings, scores, handicaps', 'NTP/LD winners', 'Full per-player scorecard (expandable)', 'Share button (WhatsApp, copy link)', 'OG share card image', 'Persistent URL', 'Locked after finalisation'],
