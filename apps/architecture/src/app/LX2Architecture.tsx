...
const modules: Record<string, Module> = {
  ...
  club_app_scaffold: {
    ...
    sub: 'apps/club → club.lx2.golf',
    desc: 'New Next.js app in the monorepo deployed to club.lx2.golf. Shares @lx2/scoring, @lx2/db, and @lx2/ui with lx2.golf. Same Supabase project — same data, different role-gated views.',
    deps: ['auth'],
    data: ['clubs'],
    liveUrl: null, prdUrl: null, codeUrl: null,
    features: ['New apps/club Next.js app', 'Shared packages: @lx2/scoring, @lx2/db, @lx2/ui', 'club.lx2.golf Vercel deployment', 'Separate turbo pipeline from apps/web', 'Dark admin UI — distinct from lx2.golf'],
    tech: 'Next.js App Router. Turborepo workspace. Vercel project linked to club.lx2.golf subdomain.',
  },
  club_auth: {
