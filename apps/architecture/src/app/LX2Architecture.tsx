...
const modules: Record<string, Module> = {
  ...
  predictions: {
    ...
    features: [
      ...
      'Virtual bankroll: default 1,000 credits/event (organiser-configurable: 500–5,000 or custom), no top-ups, max bet 20% of bankroll',
      ...
      'Advanced organiser mode: starting credits, custom overround, max bet limit, market selection, manual odds override, prop bet templates',
