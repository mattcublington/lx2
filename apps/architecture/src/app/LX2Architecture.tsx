...
const modules: Record<string, Module> = {
  ...
  score_entry: {
    ...
    features: [
      ...
      'Offline queue — LocalStorage fallback, auto-drained on reconnect',
      'RLS: players write own scores; organiser writes scores for all players in their event',
    ],
  ...
  course_db: {
    ...
    liveUrl: null,
    prdUrl: null,
    codeUrl: `${GITHUB}/packages/db/migrations/golfer/003_golfer_seed_cumberwell_loops.sql`,
    features: [
